...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        self.password = key
        self.text = text
        # print("Input string:", self.text)
        # print()
        # print("Secret key:", self.password)
        # print()
    ...
    def substitute(self, d_e):#Substitute bytes using SBOX
        ...
        # print("Split subblock 1:", subblocks[0])
        # print("Split subblock 2:", subblocks[1])
        ...
        for i in range(len(subblocks)): #For all the sublists
            ...
            # print("Sbox{} -> {}".format(i, val))
            bin = binvalue(val, 4)#Convert the value to binary
            # print("Sbox bits {} -> {}".format(i, bin))
    ...
    def generatekeys(self):#Algorithm that generates all the keys
        ...
        for i in range(16):#Apply the 16 rounds
            ...
            tmp = g + d #Merge them
            # print("Rotated and merged bits:", tmp)
            # print()
